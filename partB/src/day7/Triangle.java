...
/* ※오버라이드※
 ...
 부모클래스의 메소드 동작을 자식클래스가 수정(재정의)하는 것을 #@*오버라이드*@# 라고 합니다.
...
이 메소드는 오버라이드 메소드라는 표시. 오버라이드 형식에 맞지 않으면 오류. */
	...
	public int calculateArea() {
		return super.calculateArea()/2;				//super. 생략 가능? 불가능?
	...
	// Triangle 객체의 인스턴스 메소드 					//부모클래스에서 불러올수 없다면 만들어 줘야겠지??!!
