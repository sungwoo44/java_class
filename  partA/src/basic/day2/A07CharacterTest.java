...
public class A07CharacterTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("///////////////int & char 변수 사이의 캐스팅///////////////");
		int code3 = c3; // c3은 '가' 를 int 로 자동 캐스팅하면 44032
		char temp = (char)code3; //int 를 char 로 형식 변경하는 것은 강제 캐스팅
		...
		System.out.println("변경된 c3 문자: " + (int) c3); // char를 int로 강제 캐스팅. '갂'

		// 문자와 코드 정수값(다국어 문자가 아닌 영문자, 숫자 기호는 기본적으로 사스키코드 사용.)
